...
public abstract class WSBaseConfig implements WebMvcConfigurer {
    ...
    @Bean
    public EolBannerInfoHelper eolBannerInfoHelper(Messages messages) {
        return new EolBannerInfoHelper(messages);
    }

    @Bean
    public CertRenewalInfoHelper certRenewalInfoHelper(Messages messages) {
        return new CertRenewalInfoHelper(messages);
    }
