...
public class FaqHelper {
    ...
    public FaqHelper(Messages msg) {
        ...
        walletQuestionsFaqConfig.setFaqEntries(List.of("1", "1_1", "2", "3", "4", "5"));
        ...
        walletWorksFaqConfig.setFaqEntries(List.of("1", "2", "3", "4", "5", "6"));
        ...
        walletTransferWorksFaqConfig.setFaqEntries(List.of("1", "2", "3"));
        ...
        verifierWorksFaqConfig.setFaqEntries(List.of("1", "2", "3", "5", "6"));
    }
    ...
    private Map<Language, Faq> getFaq(FaqConfig faqConfig) {
        ...
        for (Language language : Language.values()) {
            ...
            if (List.of(
                            walletTransferWorksFaqConfig.getKeyPrefix(),
                            walletTransferQuestionsFaqConfig.getKeyPrefix())
                    .contains(prefix)) {
                if (!Language.DE.equals(language)) {
                    continue; // missing translations. skip other languages
                }
            }
