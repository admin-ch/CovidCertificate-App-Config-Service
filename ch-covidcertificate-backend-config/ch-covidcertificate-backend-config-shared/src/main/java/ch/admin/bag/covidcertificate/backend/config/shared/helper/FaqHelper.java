...
public class FaqHelper {
	...
	private static final List<String> WALLET_FAQ_QUESTIONS_ENTRIES = List.of("1", "2", "3", "4", "5");
	private static final List<String> WALLET_FAQ_WORKS_ENTRIES = List.of("1", "2", "3", "4", "5", "6");

	private static final List<String> VERIFIER_WORKS_FAQ_ENTRIES = List.of("1", "2", "3", "4", "5", "6");
